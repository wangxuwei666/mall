 ...
 *
 */
package com.youmu.common.http.utils;
 ...
 * http请求.
 * @author zh
 * @version $Id: HttpClient.java, v 0.1 2017年3月9日 上午10:04:23 zh Exp $
 */
public class HttpUtils {
        ...
        public static String postXmlBody(String url, int timeout, Map<String, Object> map, String encoding){
            ...
            try {
                ...
                String paramXml = WxTools.getXml(map);
                post.setEntity(new StringEntity(paramXml, encoding));
                logger.info("[HttpUtils Post] begin invoke url:" + url + " , params:"+paramXml);
        ...
        public static String get(String url, Map<String, String> params) {
            return invokeGet(url, params, "UTF-8", connectTimeout, soTimeout);
        }
